(function (global, factory) {
    ...
    const identifierStartRegex = /[$_A-Za-z_]|\\u0-9A-Fa-f{4}|\\u\{0*(?:0-9A-Fa-f{1,5}|100-9A-Fa-f{4})\}/u;
    // A hyphen is not technically allowed, but to keep it liberal for now,
    //  adding it here
    const identifierContinueRegex = /[$\-A-Za-z0-9_\u200C\u200D]|\\u0-9A-Fa-f{4}|\\u\{0*(?:0-9A-Fa-f{1,5}|100-9A-Fa-f{4})\}/u;
